...
const JobApplyInterviewer = express_1.default.Router();
...
JobApplyInterviewer.post("/api/v1/InterviewerJobApply", token_auth_1.AuthToken, (req, resp) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.default = JobApplyInterviewer;
