...
export default function Profile() {
  ...
  useEffect(()=>{
    async function Data() {
      ...
      const data = await axios.get(`http://localhost:${import.meta.env.VITE_PORT}/api/v1/profile/`, 
        ...
        if(data.data.information != undefined){
          ...
          const obj : ProfileData = {
            ...
            lastName : response[1],
            email : response[2],
            dateOfBirth : response[3],
            location : response[4],
            mobileNumber : response[5],
            qualifications : response[6],
            skills : response[7],
            universityName : response[8]
          }
  ...
  const handleSubmit = async(e: React.FormEvent) => {
    ...
    await axios.post(`http://localhost:${import.meta.env.VITE_PORT}/api/v1/profile/`,{profileData},{withCredentials : true})
  };
